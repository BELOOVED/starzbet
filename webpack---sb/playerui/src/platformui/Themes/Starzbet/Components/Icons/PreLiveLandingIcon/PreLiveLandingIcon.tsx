...
const PreLiveLandingIconSvg = memo(() => (
  <svg
    ...
    fill={"none"}
  >
    <g clipPath={"url(#clip0_704_34598)"}>
      <path
...
PreLiveLandingIconSvg.displayName = "PreLiveLandingIconSvg";

const PreLiveLandingIcon = withProps(Icon)({ svgComponent: PreLiveLandingIconSvg });

export { PreLiveLandingIcon };
