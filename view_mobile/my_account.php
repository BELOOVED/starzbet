<div class="account-page--ncXf9" style="margin-top: 80px;" data-cy="player_ui__page__content">
      <div class="children-container--tgv6c">
         <div class="sidebar--sXkeV mobile-sidebar--AMlqP" data-cy="player_ui__my_account_menu__container__menu">
            ...
            <div class="menu--prt93" data-cy="player_ui__my_account_menu__container__navigation">
               ...
               <div class="menu--eQSVE button-list--G78Bp">
                  ...
                  <a aria-current="page" class="menu-element--ITJgP with-icon-menu-element--JMwvG list-item--BFlho active" href="/tr-tr/my_account">
                     <div class="icon--hFega">
                        <span class="wrapper--fQhcx" style="height: 16px; width: 16px; min-width: 16px;">
               ...
               <div class="logout--rzYJm logout--y9_Ct">
                  <div>
                     <span class="wrapper--fQhcx" style="height: 16px; width: 16px; min-width: 16px;">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
