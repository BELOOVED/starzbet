...
const PlayLimitIconSvg = memo(() => (
  ...
  >
    ...
    <defs>
      <clipPath id={"clip0_8_91176"}>
        <rect width={"24"} height={"24"} fill={"white"} />
      </clipPath>
    </defs>
  </svg>
));
PlayLimitIconSvg.displayName = "PlayLimitIconSvg";

const PlayLimitIcon = withProps(Icon)({ svgComponent: PlayLimitIconSvg });

export { PlayLimitIcon };
