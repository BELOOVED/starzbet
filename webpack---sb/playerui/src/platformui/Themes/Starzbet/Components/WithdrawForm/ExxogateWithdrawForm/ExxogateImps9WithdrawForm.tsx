...
import { EXXOGATE_IMPS_9_WITHDRAWAL_FORM_FIELD_PATHS } from "../../../../../Store/Banking/Form/Exxogate/ExxogateForm";
import { AmountField } from "../AmountField/AmountField";
import { AccountInfo } from "../AccountInfo/AccountInfo";

const ExxogateImps9WithdrawForm = memo(() => {
  ...
  return (
    <>
      ...
      <div className={classes.form}>
        <TextField
          fieldPath={EXXOGATE_IMPS_9_WITHDRAWAL_FORM_FIELD_PATHS.address}
          label={t(platformui_starzbet_headline_address)}
          placeholder={t.plain(platformui_starzbet_placeholder_enterText)}
        />

        <TextField
          fieldPath={EXXOGATE_IMPS_9_WITHDRAWAL_FORM_FIELD_PATHS.ifsc}
          label={t(platformui_starzbet_title_ifscBeneficiary)}
          placeholder={t.plain(platformui_starzbet_placeholder_enterText)}
        />

        <TextField
          fieldPath={EXXOGATE_IMPS_9_WITHDRAWAL_FORM_FIELD_PATHS.personId}
          label={t(platformui_title_personId)}
          placeholder={t.plain(platformui_starzbet_placeholder_enterText)}
        />

        <TextField
          fieldPath={EXXOGATE_IMPS_9_WITHDRAWAL_FORM_FIELD_PATHS.phone}
...
ExxogateImps9WithdrawForm.displayName = "ExxogateImps9WithdrawForm";

export { ExxogateImps9WithdrawForm };
