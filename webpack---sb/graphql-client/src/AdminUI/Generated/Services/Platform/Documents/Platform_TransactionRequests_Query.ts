...
export const Platform_TransactionRequests_Query: TDocument<TPlatform_TransactionRequests_QueryOptionalFields> = process.env.GRAPHQL_PERSISTED === "strict"
        ? () => () => ""
        : createDocument<TPlatform_TransactionRequests_QueryOptionalFields>("query Platform_TransactionRequests($cursor: Cursor, $where: Platform_TransactionRequestWhereInput, $orderBy: [Platform_TransactionRequestOrderBy!]) { platform @normalize { TransactionRequests(cursor: $cursor, orderBy: $orderBy, where: $where) { ...Platform_TransactionRequestsPage } } }", {
...
Platform_TransactionRequests_Query.extra = createDocument<TPlatform_TransactionRequests_QueryOptionalFields>(
  process.env.GRAPHQL_PERSISTED === "strict" ? "" : "query Platform_TransactionRequests($cursor: Cursor, $where: Platform_TransactionRequestWhereInput, $orderBy: [Platform_TransactionRequestOrderBy!]) { platform @normalize { TransactionRequests(cursor: $cursor, orderBy: $orderBy, where: $where) { __typename pageInfo { __typename total } } } }",
  {},
);
