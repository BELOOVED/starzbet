...
const BandyIconSvg = memo(() => (
  ...
  >
    <g clipPath={"url(#clip0_1_2996)"}>
      ...
      <path
        d={"M16.168 14.668L18.551 17.051"}
        stroke={"currentColor"}
        strokeWidth={"1.5"}
        strokeLinecap={"round"}
        strokeLinejoin={"round"}
      ...
      <path
        d={"M18.546 7.2959L20.929 9.6789"}
        stroke={"currentColor"}
        strokeWidth={"1.5"}
        strokeLinecap={"round"}
        strokeLinejoin={"round"}
...
BandyIconSvg.displayName = "BandyIconSvg";

const BandyIcon = withProps(Icon)({ svgComponent: BandyIconSvg });
