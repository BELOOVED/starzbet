...
import { isBonusWonEventReceivedSelector } from "../../../../platformui/Store/Bonuses/Selectors/BonusesSelectors";
...
const createBonusWonModal = (
  BonusWonPrompt: ComponentType<TModalPromptActionProps>,
) => withCondition(
  isBonusWonEventReceivedSelector,
  memo(() => {
    const onClose = useActionWithBind(bonusEventDataModalClosedAction, "playerBonusWonEvent");
    ...
    return <BonusWonPrompt onOk={onOk} onCancel={onClose} />;
  }),
);

export { createBonusWonModal };
