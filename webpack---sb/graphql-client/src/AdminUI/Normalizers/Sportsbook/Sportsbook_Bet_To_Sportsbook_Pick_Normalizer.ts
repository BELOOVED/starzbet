...
type TSportsbook_Bet_To_Sportsbook_Pick_Record = TRecord & {
    ids: string[];
};

type TSportsbook_Bet_To_Sportsbook_Pick_AdditionalData = { id: string; };
...
const Sportsbook_Bet_To_Sportsbook_Pick_Normalizer = normalizerCreator<
    TSportsbook_Bet_Fragment,
    TSportsbook_Bet_To_Sportsbook_Pick_Record,
    TSportsbook_Bet_To_Sportsbook_Pick_AdditionalData
>(
  ESportsbook_Typename.sportsbookBet,
  ERecordName.sportsbookBetToSportsbookPick,
...
export type { TSportsbook_Bet_To_Sportsbook_Pick_Record };
export { Sportsbook_Bet_To_Sportsbook_Pick_Normalizer };
