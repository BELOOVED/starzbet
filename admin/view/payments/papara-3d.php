...
<div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">3D Papara Ödemeleri </h4>
                                </div>
                                <div class="card-body">
    ...
    <? } ?>
        ...
        <?php
          $status = [
            ...
            array('title' => 'Email Onayında', 'icon' => 'primary')
          ];
             ...
             <div class="btn-group" role="group">
              ...
              <?php if ($_SESSION['status'] == '0') { ?>
                  ...
                  <?php if ($res['status'] == 0) { ?>
                    ...
                    <button class="btn btn-primary" onclick="changeStatus(<?=$res['id']?>, 4, <?=$res['user_id']?>, <?=$res['amount']?>)" class="btn btn-default btn-sm">Email</button>
