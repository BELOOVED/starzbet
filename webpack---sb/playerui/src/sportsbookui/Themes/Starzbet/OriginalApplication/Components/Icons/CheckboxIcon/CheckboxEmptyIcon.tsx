...
const CheckboxEmptyIconSvg = memo(() => (
  <svg
    width={"24"}
    height={"24"}
    viewBox={"0 0 24 24"}
...
CheckboxEmptyIconSvg.displayName = "CheckboxEmptyIconSvg";

const CheckboxEmptyIcon = withProps(Icon)({ svgComponent: CheckboxEmptyIconSvg });

export { CheckboxEmptyIcon };
