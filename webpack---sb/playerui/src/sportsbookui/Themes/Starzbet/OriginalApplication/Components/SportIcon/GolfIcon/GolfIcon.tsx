...
const GolfIconSvg = memo(() => (
  ...
  >
    ...
    <path d={"M7 19H9C10.1 19 11 19.9 11 21V22H13V21C13 19.9 13.9 19 15 19H17V17H7V19Z"} fill={"currentColor"} />
  </svg>
));
GolfIconSvg.displayName = "GolfIconSvg";

const GolfIcon = withProps(Icon)({ svgComponent: GolfIconSvg });
