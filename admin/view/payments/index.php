...
<div class="col-xl-12">
 ...
 <script src="https://code.jquery.com/jquery-3.6.1.min.js" integrity="sha256-o88AwQnZB+VDvE9tvIXrMQaPlFFSUTR+nldQm1LuPXQ=" crossorigin="anonymous"></script>
    ...
    function fetchPayments() {
        $.ajax({
            url: "/<?=$main['admin_path']?>/view/payments/fetch_payments.php",
            type: "GET",
    ...
    // Sonrasında her 5 saniyede bir yeniden çalıştır
    setInterval(fetchPayments, 2000); // 5000 milisaniye = 5 saniye
});
