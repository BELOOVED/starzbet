...
} from "../../../common/Store/Player/Selectors/PlayerSelectors";
...
import { playGameGameSelector, playGameStateSelectors } from "./PlayGameSelectors";
...
/**
 * should be called just on 'routeMap.play', 'routeMap.playDemo' routes after game is loaded
 */
const internalBonusMatchedWithGameNullableSelector = createSimpleSelector(
  [playGameGameSelector, playGameStateSelectors.playerBonuses],
  (game, playerBonuses) => {
...
const isBonusCanceledModalVisibleSelector = createSimpleSelector([playGameStateSelectors.playerBonusHasBeenCanceled], isNotNil);
const isBonusWonModalVisibleSelector = createSimpleSelector([playGameStateSelectors.playerBonusHasBeenWon], isNotNil);
const isBonusLostModalVisibleSelector = createSimpleSelector([playGameStateSelectors.playerBonusHasBeenLost], isNotNil);
const isBonusCompletedModalVisibleSelector = createSimpleSelector([playGameStateSelectors.playerBonusHasBeenCompleted], isNotNil);
const isBonusActivatedModalVisibleSelector = createSimpleSelector([playGameStateSelectors.playerBonusHasBeenActivated], isNotNil);
const isBonusProceededToWageringStageModalVisibleSelector = createSimpleSelector(
  [playGameStateSelectors.playerBonusProceededToWageringStage, isPlayerBonusWalletExistSelector],
  (event, isBonusWalletExist) => isNotNil(event) && isBonusWalletExist,
);

const isBonusEventReceivedSelector = createSimpleSelector(
  [
    playGameStateSelectors.playerBonusHasBeenCanceled,
    playGameStateSelectors.playerBonusHasBeenActivated,
    playGameStateSelectors.playerBonusHasBeenLost,
    playGameStateSelectors.playerBonusHasBeenCompleted,
    playGameStateSelectors.playerBonusHasBeenWon,
    playGameStateSelectors.playerBonusProceededToWageringStage,
  ],
  (...events) => events.some(isNotNil),
);
