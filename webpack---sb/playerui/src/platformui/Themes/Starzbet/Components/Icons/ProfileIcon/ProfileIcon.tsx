  ...
  >
    ...
    <defs>
      <clipPath id={"clip0_626_17"}>
        <rect width={"16.0007"} height={"16"} fill={"currentColor"} />
      </clipPath>
    </defs>
  </svg>
));
ProfileIconSvg.displayName = "ProfileIconSvg";

const ProfileIcon = withProps(Icon)({ svgComponent: ProfileIconSvg });

const ProfileIconLogin = withProps(Icon)({ svgComponent: ProfileIconSvg, color: "blue", size: "m" });

export { ProfileIcon, ProfileIconLogin };
